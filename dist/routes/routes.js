...
function RegisterRoutes(app) {
    ...
    app.post('/user/login', ...((0, runtime_1.fetchMiddlewares)(controller_1.userController)), ...((0, runtime_1.fetchMiddlewares)(controller_1.userController.prototype.login)), async function userController_login(request, response, next) {
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
